...
test_that("updates recovery delay to prolong presence-based impacts", {
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 0))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 0))
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 1))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 1))
  expect_equal(attr(n, "recovery_delay")[[1]][idx],
               expected_recovery_delay_1[idx])
  expect_equal(attr(n, "recovery_delay")[[2]][idx],
               expected_recovery_delay_2[idx])
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 2))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 2))
  expect_equal(attr(n, "recovery_delay")[[1]][idx],
               expected_recovery_delay_1[idx])
  expect_equal(attr(n, "recovery_delay")[[2]][idx],
               expected_recovery_delay_2[idx])
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 3))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 3))
  expect_equal(attr(n, "recovery_delay")[[1]][idx],
               expected_recovery_delay_1[idx])
  expect_equal(attr(n, "recovery_delay")[[2]][idx],
               expected_recovery_delay_2[idx])
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 4))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 4))
  expect_equal(attr(n, "recovery_delay")[[1]][idx],
               expected_recovery_delay_1[idx])
  expect_equal(attr(n, "recovery_delay")[[2]][idx],
               expected_recovery_delay_2[idx])
...
test_that("updates recovery delay to prolong density-based impacts", {
  ...
  expect_equal(calc_impacts[[1]][idx], expected_impact_1[idx])
  expect_equal(calc_impacts[[2]][idx], expected_impact_2[idx])
  expect_silent(n <- impacts_1$update_recovery_delay(n, 5))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 5))
  expect_equal(attr(attr(n, "recovery_delay"), "incursions"),
...
test_that("calculates spatially implicit impacts via area occupied", {
  ...
  expect_silent(impacts_2 <- Impacts(region, population_model,
                                     ...
                                     stages = 2:3))
  expect_silent(impacts_2$set_id(2))
  expect_error(n <- impacts_1$calculate(n, 0),
  ...
  expect_silent(n <- impacts_2$calculate(n, 3))
  calc_impacts <- attr(n, "impacts")
  expect_equal(calc_impacts, list(100*30*0.3, 200*50*0.4))
  expect_silent(n <- impacts_1$update_recovery_delay(n, 3))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 3))
  ...
  expect_silent(n <- impacts_2$calculate(n, 4))
  calc_impacts <- attr(n, "impacts")
  expect_equal(calc_impacts, list(0, 200*30*0.4))
  expect_silent(n <- impacts_1$update_recovery_delay(n, 4))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 4))
  expect_equal(attr(attr(n, "recovery_delay"), "incursions"),
               c(0, 0, 0, 30, 50))
...
test_that("applies dynamic presence-based impacts", {
  ...
  idx <- 5901:6000
  population_model <- UnstructPopulation(region, growth = 1.2)
  asset_value <- list(100*(template > 0.1 & template < 0.4),
                      200*(template > 0.3))
  expect_silent(impacts_1 <- Impacts(region, population_model,
                                     valuation_type = "dynamic",
                                     asset_name = "impact1",
  ...
  n[idx[c(1:10, 51:55)]] <- 0
  expected_impacts <-
    list((n > 0)*asset_value[[1]][region$get_indices()][,1]*0.3,
         (n > 0)*asset_value[[2]][region$get_indices()][,1]*0.4)
  expected_dynamic_mult <- list(1 - 0.3*(n > 0), 1 - 0.4*(n > 0))
  ...
  n[idx[c(11:20, 56:60)]] <- 0
  expected_dynamic_mult[[1]] <- (1 - 0.3*(n > 0))*expected_dynamic_mult[[1]]
  expected_dynamic_mult[[1]][which(n == 0)] <- 1
  expected_dynamic_mult[[2]] <- (1 - 0.4*(n > 0))*expected_dynamic_mult[[2]]
  expected_dynamic_mult[[2]][which(n == 0)] <- 1
  expected_impacts <- lapply(1:2, function(i) {
    impact <- (asset_value[[i]][region$get_indices()][,1]*
...
test_that("applies dynamic implicit area-based impacts with recovery", {
  ...
  expect_equal(attr(n, "impacts"), expected_impacts)
  expect_equal(attr(n, "dynamic_mult"), expected_dynamic_mult)
  expect_silent(n <- impacts_1$update_recovery_delay(n, 6))
  expect_silent(n <- impacts_2$update_recovery_delay(n, 6))
  expect_equal(lapply(attr(n, "recovery_delay"), function(d) d),
               expected_recovery_delay)
  expect_equal(attr(attr(n, "recovery_delay"), "incursions"),
               c(0, 0, 0, 0, 50, 30, 50))
